...
const HomeStaging = ({ data }) => (
    <ContentWrapperHomestaging isSubpage>
        ...
        <CornerEffect position="topLeft" size={(!(typeof window === "undefined") &&(window.innerWidth>1100)) ? "100px" : "0px"} distance="30px" color="beige">
            <PortfolioItem isOdd>
                <div>
        ...
        <CornerEffect position="bottomRight" size={(!(typeof window === "undefined")  &&(window.innerWidth>1100)) ? "100px" : "0px"} distance="30px" color="dark">
            <PortfolioItem>
                <div>
        ...
        <CornerEffect position="bottomRight" size={(!(typeof window === "undefined") &&(window.innerWidth>1100)) ? "100px" : "0px"} distance="30px" color="beige">
